...
public class ICD_EU {
	...
	public static void main(String[] args) throws IOException,
			DocumentException {
		PdfReader reader = new PdfReader("ScreenLink report_ICD_EU.pdf");
		...
		new ICD_EU().createCRT_AUSTRALIA_Pdf(document);
	...
	public void createCRT_AUSTRALIA_Pdf(Document document)
		...
		Paragraph line = new Paragraph(
				"ICD is recommended according to ESC Guidelines (Class I indication) because of the following reasons :",
				fontBold10);
